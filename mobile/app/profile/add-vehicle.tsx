...
export default function AddVehicleScreen() {
  ...
  useEffect(() => {
    const fetchTypes = async () => {
      try {
        ...
        const res: any = await vehicleTypeApi.getVehicleTypes();
  ...
  // ── Validate biển số VN (giống trang đặt chỗ) ──
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (isDefault) payload.isDefault = true;
        ...
        >
          ...
          <View style={styles.stepHeader}>
            ...
            <Text style={styles.stepTitle}>
              Chọn loại xe <Text style={{ color: Colors.danger }}>*</Text>
            </Text>
          </View>
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          ...
                          // Reset plate khi đổi loại xe vì format khác nhau
                          setLicensePlate("");
                          setPlateError("");
                        }}
                        activeOpacity={0.7}
          ...
          {/* ── Step 2: Biển số (giống trang đặt chỗ) ── */}
          <View style={styles.stepHeader}>
            <View style={styles.stepBadge}>
          ...
          {/* ── Preview Card ── */}
          {selectedTypeId && licensePlate.trim() && (
