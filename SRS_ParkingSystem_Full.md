...
### Thiết kế thuật toán đề xuất (Weighted Scoring Model)
...
|-------|------|-------------|
| Phase 2 (Tuần 2–3) | 2–3 | Thiết kế API gợi ý tầng (FR-8.3) hỗ trợ 2 mode: `auto-assign` / `manual` |
| Phase 3 (Tuần 4–5) | 4–5 | Implement thuật toán weighted scoring cho auto-assign. Thu thập dữ liệu baseline |
| Phase 4 (Tuần 6–7) | 6–7 | Implement load balancing cho giờ cao điểm. Tích hợp reservation vào thuật toán |
| Phase 5 (Tuần 8) | 8 | A/B testing, thu thập metrics, phân tích kết quả RQ1–RQ4 |
| Phase 6 (Tuần 9) | 9 | Tổng hợp báo cáo nghiên cứu, so sánh giả thuyết với kết quả thực tế |
