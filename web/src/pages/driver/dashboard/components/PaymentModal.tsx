...
export const PaymentModal: React.FC<PaymentModalProps> = ({ isOpen, onClose, sessionId, amount }) => {
        ...
        >
          ...
          <div className="p-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-4xl font-bold text-[#10b981] font-mono">{amount.toLocaleString('vi-VN')}₫</h2>
            </div>
            ...
            <div className="space-y-3 mb-8">
              ...
              >
                ...
                {method === 'MoMo' && <div className="ml-auto w-3 h-3 rounded-full bg-[#a50064]"></div>}
              </button>
              ...
              >
                ...
                {method === 'VNPAY' && <div className="ml-auto w-3 h-3 rounded-full bg-[#005baa]"></div>}
              </button>
            </div>
            ...
            >
              {isProcessing ? <><Loader2 className="animate-spin" /> Đang xử lý...</> : 'Xác Nhận & Thanh Toán'}
            </button>
          </div>
        </motion.div>
      </div>
