      ...
      >
        ...
        <div className="relative w-48 h-48 mb-8 flex items-center justify-center">
          ...
          <div className="relative z-10 w-32 h-32 bg-white rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-slate-100 flex items-center justify-center overflow-hidden">
             {/* Map background grid */}
             <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'radial-gradient(circle at center, #000 1.5px, transparent 1.5px)', backgroundSize: '16px 16px' }} />
             ...
             >
                ...
                >
                  <Navigation size={22} className="text-emerald-500 drop-shadow-sm fill-emerald-500" />
                </motion.div>
             </motion.div>
          </div>
        </div>
        ...
        >
          Bạn chưa gửi chiếc xe nào tại hệ thống của chúng tôi. Khám phá các bãi đỗ xe thông minh ngay gần bạn nhé!
        </motion.p>
