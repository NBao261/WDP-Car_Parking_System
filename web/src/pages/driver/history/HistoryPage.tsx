...
const HistorySkeleton = () => (
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
    {[1, 2, 3, 4].map((i) => (
      <div
        key={i}
        className="bg-card border border-border rounded-2xl p-5 shadow-sm flex flex-col h-[200px]"
      >
...
const EmptyStateIllustration = () => (
  ...
  >
    ...
    {/* Car shape */}
    <path
      d="M107.5 90H52.5C49.7386 90 47.5 87.7614 47.5 85V75L55 60H105L112.5 75V85C112.5 87.7614 110.261 90 107.5 90Z"
      fill="#CBD5E1"
    />
    ...
    <div className="w-full h-full pb-20">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Xem lại các lần đặt chỗ và lịch sử gửi xe trước đây.
        </p>
      </div>
      ...
      {reservations.length === 0 ? (
        ...
        >
          ...
          <p className="text-muted-foreground mb-8 max-w-md">
            Bạn chưa có đặt chỗ hoặc lịch sử gửi xe nào. Hãy bắt đầu bằng việc tìm bãi xe và đặt chỗ
            trước nhé.
          </p>
          <motion.button
