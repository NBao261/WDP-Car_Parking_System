    ...
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-3">
        {(['30m', '1h', '2h', 'custom'] as const).map((mode) => (
          ...
          >
            {mode === '30m' ? 'Trong 30p' : mode === '1h' ? 'Trong 1 giờ' : mode === '2h' ? 'Trong 2 giờ' : 'Tùy chọn'}
          </button>
        ))}
      </div>
      ...
      <AnimatePresence mode="wait">
        {!isTimeValid() ? (
          ...
          >
            ...
            <p className="text-sm font-medium">Giờ tùy chọn không hợp lệ. Phải đặt trước ít nhất 30 phút.</p>
          </motion.div>
        ) : (
          <motion.div 
          ...
          >
            ...
            <p className="text-xs leading-relaxed">
              Chỗ của bạn sẽ được giữ trong vòng <strong>30 phút</strong> tính từ giờ hẹn. Vui lòng đến đúng giờ để tránh bị hủy tự động.
            </p>
          </motion.div>
        )}
      </AnimatePresence>
