    ...
    <>
      <div className="flex flex-col gap-1 mt-1">
        ...
        <input type="text" value={displayPlate}
          ...
          className={`w-full h-9 text-[18px] text-center font-mono px-3 border rounded-[6px] uppercase font-bold outline-none transition-all duration-200 disabled:opacity-70 cursor-not-allowed pointer-events-none select-none
            ${checkInError
