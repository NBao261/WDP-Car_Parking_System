      ...
      <div className="grid grid-cols-2 gap-2 mt-1">
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            readOnly
            tabIndex={-1}
            className={`w-full h-9 text-[18px] text-center font-mono px-3 border border-[#e8e9e8] rounded-[6px] uppercase font-bold outline-none cursor-not-allowed pointer-events-none select-none ${plateIn ? 'bg-[#ECFCCB] text-[#1A202C]' : 'bg-[#fdfdfd] text-[#9b9b9b]'}`}
