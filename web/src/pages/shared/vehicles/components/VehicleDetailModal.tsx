...
export function VehicleDetailModal({ isOpen, onClose, vehicle }: DetailModalProps) {
  const [facilitiesWithFloors, setFacilitiesWithFloors] = useState<Record<string, { id: string, name: string, floors: { id: string, name: string }[] }>>({});
      ...
      const fetchLinks = async () => {
        ...
        try {
          ...
          const grouped = linkedFloors.reduce((acc: any, floor: Floor) => {
            const facId = typeof floor.facilityId === 'string' ? floor.facilityId : (floor.facilityId as any)?._id;
        ...
        >
          ...
          <div className="p-6 space-y-6 overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Kích Thước Slot</p>
