...
export const ICON_OPTIONS: { name: string; label: string; Icon: LucideIcon }[] = [
  ...
  { name: 'ElectricBike', label: 'Xe máy điện',    Icon: Zap          },
  ...
  { name: 'Ambulance',    label: 'Xe cứu thương',  Icon: Ambulance    },
  { name: 'Tractor',      label: 'Máy kéo',        Icon: Tractor      },
  { name: 'Caravan',      label: 'Xe caravan',     Icon: Caravan      },
];
