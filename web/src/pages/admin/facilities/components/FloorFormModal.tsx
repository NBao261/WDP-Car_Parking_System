      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
            <div>
              <h2 className="text-lg font-bold text-[#060606]">{isEdit ? 'Chỉnh sửa tầng' : 'Thêm tầng mới'}</h2>
              <p className="text-xs text-gray-500 mt-0.5">{isEdit ? 'Cập nhật thông tin & phân loại xe' : 'Tạo tầng và gán loại xe'}</p>
            </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 overflow-y-auto flex-1 space-y-4">
            <div>
              ...
              <input type="text" required value={name} onChange={(e) => setName(e.target.value)}
                ...
                placeholder="VD: Tầng B1, Tầng 1, Khu A..."
              />
            </div>

            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1.5">Tổng số slot <span className="text-red-500">*</span></label>
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                Loại xe được phép <span className="text-red-500">*</span>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {vehicleTypes.length === 0 && (
                  <p className="text-xs text-gray-400">Chưa có loại xe nào. Hãy tạo loại xe trước.</p>
                )}
              </div>
            </div>
