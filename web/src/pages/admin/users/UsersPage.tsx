...
export default function UserListPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h1 className="text-2xl font-bold text-[#062F28]">Users &amp; Roles</h1>
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[#9FE870] p-6 rounded-[24px] shadow-sm text-[#062F28] flex flex-col justify-between relative overflow-hidden min-h-[220px]">
          ...
          <div className="relative z-10 flex justify-between items-start">
            <h3 className="font-medium text-[16px]">Tổng số tài khoản</h3>
            <button
              onClick={handleCreateUser}
          ...
          <div className="relative z-10 flex gap-3 mt-auto">
            ...
            >
              Thêm User <ArrowUpRight size={16} strokeWidth={2} />
            </button>
          </div>
        </div>
