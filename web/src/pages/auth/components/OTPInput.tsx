  ...
  return (
    <div className="flex justify-between gap-2 w-full">
      {[0, 1, 2, 3, 4, 5].map((index) => {
        let inputClasses = "w-[40px] h-[46px] sm:w-[46px] sm:h-[46px] text-center font-bold text-[18px] text-[#062F28] rounded-lg border-[1.5px] outline-none transition-all duration-200 bg-white ";
        if (hasError) {
          inputClasses += "border-red-500 shadow-[0_0_0_3px_rgba(239,68,68,0.18)] focus:border-red-500";
        } else {
          inputClasses += "border-[#E7E7F1] focus:border-[#9FE870] focus:shadow-[0_0_0_3px_rgba(159,232,112,0.18)]";
        }
